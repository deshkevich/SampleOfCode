...
public class GiftCardDev {
    ...
    public void giftCardPurchase() {
        user = new PrivateCustomer(KomplettPlatform.DEV_KOMPLETT_NO);
        mainPage = new MainPage(KomplettPlatform.DEV_KOMPLETT_NO);
    ...
    public void giftCardPurchaseBusinessCustomer() {
        businessCustomer = new BusinessCustomer(KomplettPlatform.DEV_KOMPLETT_NO);
        mainPage = new MainPage(KomplettPlatform.DEV_KOMPLETT_NO);
