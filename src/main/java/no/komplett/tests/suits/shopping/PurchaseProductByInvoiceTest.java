 ...
 */
public class PurchaseProductByInvoiceTest {
    ...
    public static Object[][] platforms() {
        return new Object[][] {
                {KomplettPlatform.TEST_KOMPLETT_NO, "Takk for bestillingen", "01121579533"},
                {KomplettPlatform.TEST_KOMPLETT_SE, "Ditt ordernummer", "410321-9202"},
                {KomplettPlatform.TEST_KOMPLETT_DK, "Dit ordrenummer", "0801363945"}
        };
    }
